...
import os
api_key = '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'
...
# Streamlit app
st.title("Indian Handsign Translator")
    ...
    if video_file is not None:
        ...
        if st.button("Generate Sentence"):
            ...
            if words:
                ...
                st.text_area("Generated Sentence",response.choices[1].text, height=150)
                os.remove(vidname)
            else:
                st.warning("Please enter words separated by commas.")

except:
    st.warning("Please Upload the file again",icon="⚠️")